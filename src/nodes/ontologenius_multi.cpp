...
bool managerHandle(const ontologenius::compat::RequestType<ontologenius::compat::OntologeniusService>& req,
                   const ontologenius::compat::ResponseType<ontologenius::compat::OntologeniusService>& res)
{
    res->code = 0;
...
int main(int argc, char** argv)
{
    ...
    ontologenius::compat::ros::Node::init(argc, argv, "ontologenius_multi");
    ...
    ontologenius::compat::ros::Service<ontologenius::compat::OntologeniusService> service("ontologenius/manage", managerHandle);
    ...
    while (ontologenius::compat::ros::Node::get().ok()) usleep(1);
