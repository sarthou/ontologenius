...
namespace onto {
  ...
  void FeederPublisher::addProperty(const std::string& from,
                                    const std::string& property,
                                    const std::string& on,
                                    const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::addRelation(const std::string& from,
                                    const std::string& property,
                                    const std::string& on,
                                    const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::addInheritage(const std::string& child,
  ...
  void FeederPublisher::addLanguage(const std::string& from,
  ...
  void FeederPublisher::addInverseOf(const std::string& property,
                                     const std::string& inverse_property,
                                     const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::removeProperty(const std::string& from,
                                       const std::string& property,
                                       const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::removeRelation(const std::string& from,
                                       const std::string& property,
                                       const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::removeInheritage(const std::string& from,
                                         const std::string& on,
                                         const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::removeLanguage(const std::string& from,
                                       const std::string& lang,
                                       const std::string& name,
                                       const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  void FeederPublisher::removeInverseOf(const std::string& property,
                                        const std::string& inverse_property,
                                        const ontologenius::compat::onto_ros::Time& stamp)
  {
  ...
  {
    std::string msg = "[nop]" + std::to_string(synchro_nb_) + "|";
    synchro_nb_++;
    return publishAndWaitSynchro(msg, timeout);
  }
  ...
  bool FeederPublisher::compareCommits(const std::string& commit_from,
                                       const std::string& commit_to)
  {
  ...
  bool FeederPublisher::publishAndWaitSynchro(const std::string& msg, int32_t timeout)
  {
    updated_ = false;
    synchro_msg_ = msg;
