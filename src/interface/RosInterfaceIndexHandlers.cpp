...
bool RosInterface::classIndexHandle(const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Request>& req,
...
bool RosInterface::objectPropertyIndexHandle(const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Request>& req,
                                             const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Response>& res)
{
  res->code = 0;
  ...
  else
  {
    ...
    if(req->action == "getDown")
      ...
      set_res_index = onto_->object_property_graph_.getDomain(params.main_index);
    else if(req->action == "getRange")
      set_res_index = onto_->object_property_graph_.getRange(params.main_index);
    else if(req->action == "getName")
    {
...
bool RosInterface::dataPropertyIndexHandle(const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Request>& req,
                                           const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Response>& res)
{
  res->code = 0;
...
bool RosInterface::individualIndexHandle(const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Request>& req,
                                         const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusIndexService::Response>& res)
{
  res->code = 0;
...
bool RosInterface::sparqlIndexHandle(const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusSparqlIndexService::Request>& req,
                                     const ontologenius::compat::ros::ServiceWrapper<ontologenius::compat::OntologeniusSparqlIndexService::Response>& res)
{
  ...
  {
    ontologenius::compat::OntologeniusSparqlIndexResponse tmp;
    for(auto& r : result)
