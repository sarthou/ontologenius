...
void ClassBranch_t::setSteady_dictionary(const std::string& lang, const std::string& word)
{
  conditionalPushBack(dictionary_.spoken_[lang], word);
  conditionalPushBack(steady_dictionary_.spoken_[lang], word);
}

void ClassBranch_t::setSteady_muted_dictionary(const std::string& lang, const std::string& word)
{
