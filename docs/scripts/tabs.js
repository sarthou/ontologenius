...
window.addEventListener("DOMContentLoaded", () => {
  const allTabs = document.querySelectorAll('.lang-tabs-tab');
  ...
  const lastSelected = session.getItem('lang-tabs-last-selected');
...
function changeTabs(e) {
  ...
  if (notSelected || notClosable) {
    ...
    if (this.classList.contains("group-tab")) {
      ...
      session.setItem('lang-tabs-last-selected', name);
    }
  }
