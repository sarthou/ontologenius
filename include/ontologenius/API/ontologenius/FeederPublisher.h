...
/// All modifications can be time-stamped for advanced uses using the republication mechanism.
    ...
    public:
        ...
        void addProperty(const std::string& from, const std::string& property, const std::string& on, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become true.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void addProperty(const std::string& from, const std::string& property, const std::string& type, const std::string& value, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become true.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void addInheritage(const std::string& from, const std::string& on, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become true.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void addLanguage(const std::string& from, const std::string& lang, const std::string& name, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        /// @brief Adds a class or individual.
        /// @param from the individual or class to add.
        /// @param stamp is the time at which the added relation become true.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void addConcept(const std::string& from, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become true.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void addInverseOf(const std::string& property, const std::string& inverse_property, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeProperty(const std::string& from, const std::string& property, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeProperty(const std::string& from, const std::string& property, const std::string& on, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeProperty(const std::string& from, const std::string& property, const std::string& type, const std::string& value, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        /// @brief Removes the inheratage: "from" is a "on". "from" and "on" could by a class, an individual or a property.
        /// @param from is the parent concept. It could by a class, an individual or a property.
        /// @param on is the child concept. It could by a class, an individual or a property.
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeInheritage(const std::string& from, const std::string& on, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeLanguage(const std::string& from, const std::string& lang, const std::string& name, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeConcept(const std::string& from, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        /// @param stamp is the time at which the added relation become false.
        /// If the time stamp stamp is not defined, the function takes the current ROS time as the time stamp.
        void removeInverseOf(const std::string& property, const std::string& inverse_property, const ontologenius::compat::ros::Time& stamp = ontologenius::compat::ros::Node::get().current_time());
        ...
        void waitConnected()
        {
            ontologenius::compat::ros::Rate loop_rate(100);

            while(ontologenius::compat::ros::Node::get().ok() && (getNumSubscribers() == 0))
                loop_rate.sleep();
        }
    ...
    private:
        ...
        ontologenius::compat::ros::Publisher<std_msgs_compat::String> pub_;
        ontologenius::compat::ros::Publisher<ontologenius::compat::OntologeniusStampedString> stamped_pub_;
        ontologenius::compat::ros::Subscriber<std_msgs_compat::String> commit_sub_;
        ontologenius::compat::ros::Subscriber<std_msgs_compat::String> notif_sub_;
        ...
        void publishStamped(const std::string& str, const ontologenius::compat::ros::Time& stamp);
