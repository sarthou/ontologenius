...
namespace ontologenius {
  ...
  private:
    ...
    template<typename T>
    std::unordered_set<T> getRelationFrom(ClassBranch_t* class_branch, int depth = -1);
    template<typename T>
    void getRelationFrom(ClassBranch_t* class_branch, std::unordered_set<T>& res, int depth);
    template<typename T>
    ...
    template<typename T>
    void getRelationOnObjectProperties(const std::string& _class, std::unordered_set<T>& res, int depth);
    ...
    template<typename T>
    void dataGetRelatedWith(ClassBranch_t* class_branch, index_t property, LiteralNode* data, std::unordered_set<T>& res, std::unordered_set<index_t>& do_not_take);
    template<typename T>
    void objectGetRelatedWith(ClassBranch_t* class_branch, index_t property, index_t _class, std::unordered_set<T>& res, std::unordered_set<index_t>& do_not_take);
    template<typename T>
    void getOn(ClassBranch_t* class_branch, std::unordered_set<index_t>& object_properties, std::unordered_set<index_t>& data_properties, std::unordered_set<T>& res, uint32_t current_depth, int& found_depth);
    ...
    template<typename T>
    void getWith_(ClassBranch_t* first_class, index_t second_class, std::unordered_set<T>& res, std::unordered_set<index_t>& do_not_take, uint32_t current_depth, int& found_depth, int depth_prop, std::unordered_set<ClassBranch_t*>& next_step);
