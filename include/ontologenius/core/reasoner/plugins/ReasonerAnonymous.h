...
namespace ontologenius {
  ...
  private:
    ...
    std::string addInferedInheritance(IndividualBranch* indiv, AnonymousClassBranch* anonymous_branch, std::vector<std::pair<std::string, InheritedRelationTriplets*>> used);
