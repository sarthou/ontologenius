...
def generate_test_description():
    ...
    test_node = launch_ros.actions.Node(
        ...
        executable='onto_reasoning_anonymous_class_test',
        name='reasoning_anonymous_class_test',
        output='screen'
    )
    ...
    return LaunchDescription([
        launch.actions.IncludeLaunchDescription(
            ...
            launch_arguments={'intern_file': 'none',
                              'display': 'false',
                              'files' : os.path.join(get_package_share_directory('ontologenius'), "files/CI/test_anonymous_classes.owl")
                              }.items(),
        ),
